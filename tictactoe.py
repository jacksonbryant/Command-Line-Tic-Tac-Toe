...
def Xs_or_Os():
    ...
    print("")
    print(p1_name + ", do you want to be Xs or Os? (Enter X or O)")
...
def game_play():
    ...
    while "0" in board or "1" in board or "2" in board or "3" in board or "4" in board or "5" in board or "6" in board or "7" in board or "8" in board or p1_choice != "Q" or p1_choice != "q" or p2_choice != "Q" or p2_choice != "q":
        ...
        if p1_XorO_choice == "X":
            if board[0] == "X" and board[6] == "X" and board[12] == "X":
                p1_wins = True
                break
                ...
                p1_wins = True
                break
            elif board[0] == "X" and board[2] == "X" and board[4] == "X":
                p1_wins = True
                break
            ...
            if board[0] == "O" and board[6] == "O" and board[12] == "O":
                p1_wins = True
                break
            elif board[2] == "O" and board[8] == "O" and board[15] == "O":
                p1_wins = True
                break
            elif board[4] == "O" and board[10] == "O" and board[16] == "O":
                p1_wins = True
                break
            elif board[0] == "O" and board[2] == "O" and board[4] == "O":
                p1_wins = True
                break
        ...
        if p2_XorO_choice == "X":
            if board[0] == "X" and board[6] == "X" and board[12] == "X":
                p2_wins = True
                break
            elif board[2] == "X" and board[8] == "X" and board[15] == "X":
                p2_wins = True
                break
            elif board[4] == "X" and board[10] == "X" and board[16] == "X":
                p2_wins = True
                ...
                p2_wins = True
                break
            if board[6] == "X" and board[8] == "X" and board[10] == "X":
                p2_wins = True
                break
            elif board[12] == "X" and board[14] == "X" and board[16] == "X":
                p2_wins = True
